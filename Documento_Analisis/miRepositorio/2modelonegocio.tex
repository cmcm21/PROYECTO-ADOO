...
Para el cambio de turno del empleado, el conteo de cajas y de efectivo se debe hacer en colaboración del empleado del turno anterior así como del siguiente turno y el supervisor que esta a cargo de ese cierre y apertura de caja, el cajero tiene que llegar hasta 5 min antes del horario para hacer efectivo el cambio de responsabilidad de la caja e inventario, en caso de anomalía el supervisor estará informado y se encargara de que se page el dinero de la bolsa del cajero que termina turno.En caso de cambio de producto: el cliente tiene que traer el recibo, el producto cerrado(encaso de estar maltratado se recibe y registra directo a cambio con el proveedor antes determinar  el  cambio  con  el  cliente),  si  el  medicamento  nuevo  tiene  un  precio  menor  se  da  la  diferencia con otro medicamento, No se puede regresar efectivo ,  y  si  el  precio  es  mayor  se  cobra  y  registra,  los  cambios y devoluciones  no  se  ven  reflejados  en  el  inventario, siempre y cuando la caja se quede con el mínimo requerido que son \$1500,los cambios y devoluciones se  registran  después  del  cambio  de turno.Los horarios de los empleados ya están definidos por el dueño. El supervisor es el encargado de que se cierre y abra la caja de forma adecuada, también de entregar un reporte diario al dueño de las ventas realizadas en las sucursales de las que esta a cargo.
