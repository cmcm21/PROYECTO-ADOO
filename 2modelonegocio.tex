...
\begin{cdtEntidad}{Medicamento}{Medicamento}
	...
	\brAttr{noIngedientesActivos}{noIngredientesActivos}{int}
		...
		\cdtEntityRelSection
	\brRel{\brRelComposition}{IngredienteActivo}{El Medicamento Esta compuesto por IngredienteActivo}
	\brRel{\brRelComposition}{Presentación}{El Medicamento tiene una Presentación}
	\brRel{\brRelComposition}{ViaAdministracion}{El Medicamento tiene una viaAdministracion}
	\brRel{\brRelComposition}{Lote}{El Medicamento tiene un Lote}
	\brRel{\brRelAgregation}{paquete Descuento}{El Medicamento se agrega a un paquete de descuento}
\end{cdtEntidad}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
...
\cdtEntityRelSection
	\brRel{\brRelComposition}{Ingreso}{La sucursal tiene muchos Ingresos de medicamentos}
